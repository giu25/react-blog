...
var data = [
    { author: "Giuseppe", text: "Ciao a tutti" },
    { author: "Jordan Walke", text: "Questo è un *altro* commento" }
];

class CommentBox extends React.Component {
    //inizializzazione da parte del costruttore dello stato con array vuoto
    constructor(props) {
        super(props);
        this.state = { data: [] };
...
class CommentForm extends React.Component {
    ...
    handleSubmit(e) {
        e.preventDefault();//evitare il componente di default ossia submit
...
ReactDOM.render(
    <CommentBox url="/api/comments" pollInterval={2000} />, //verso i dati nella comment box
